...
const CasesSucesso = () => {
    ...
    const relativeParagraph = () => {
        ...
        if (currentIndex === 2) {
            return <p>
                O site da Garsonline, projetado pela Comp Junior, proporciona uma plataforma eficiente e simplificada para contratar serviços de garçons, ideal para eventos e ocasiões especiais. Com uma interface intuitiva e recursos personalizáveis, facilita a organização de eventos e garante a satisfação dos clientes.
            </p>
        }
        if (currentIndex === 3) {
            return <p>
                O site da Stamplavras, desenvolvido pela Comp Junior, oferece uma experiência digital cativante para uma empresa de estampas renomada. Com navegação intuitiva e galerias de produtos visualmente atraentes, destaca-se como uma vitrine online elegante e funcional para os serviços de estamparia da empresa.
            </p>
        }
    }
